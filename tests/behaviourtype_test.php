 ...
 *
 * @package   qbehaviour_quizinvideofeedback
 * @category  test
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbehaviour_quizinvideofeedback_type_test extends qbehaviour_walkthrough_test_base {

    /** @var qbehaviour_quizinvideofeedback_type */
    protected $behaviourtype;

    public function setUp() {
        parent::setUp();
        $this->behaviourtype = question_engine::get_behaviour_type('quizinvideofeedback');
    }
