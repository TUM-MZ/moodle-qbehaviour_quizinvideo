 ...
 *
 * @package    qbehaviour
 * @subpackage quizinvideofeedback
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbehaviour_quizinvideofeedback_walkthrough_test extends qbehaviour_walkthrough_test_base {
    public function test_quizinvideofeedback_feedback_truefalse() {

        // Create a true-false question with correct answer true.
        $tf = test_question_maker::make_question('truefalse', 'true');
        $this->start_attempt_at_question($tf, 'quizinvideofeedback', 2);
    ...
    public function test_quizinvideofeedback_feedback_multichoice_single() {

        // Create a true-false question with correct answer true.
        $mc = test_question_maker::make_a_multichoice_single_question();
        $this->start_attempt_at_question($mc, 'quizinvideofeedback', 3);
    ...
    public function test_quizinvideofeedback_resume_multichoice_single() {
        ...
        // Reinitialise.
        $this->setUp();
        $this->quba->set_preferred_behaviour('quizinvideofeedback');
    ...
    public function test_quizinvideofeedback_resume_multichoice_single_emptyanswer_first() {
